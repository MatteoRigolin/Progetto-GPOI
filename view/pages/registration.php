...
<body>
    <form class="form-signin" method="post">
        ...
        <label for="inputName" class="sr-only mb-2">Email o Username</label>
        <input type="text" id="inputName" class="form-control mb-4" placeholder="Email o Username" name="email" required>
